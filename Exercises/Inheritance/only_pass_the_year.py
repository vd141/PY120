'''
modify the truck object to take a second argument when instantiating a new Truck
object. name the parameter bed_type. Ensure the Car constructor only accepts 
one argument
'''
