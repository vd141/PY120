'''
create cat and Dog classes that inherit from animal
...
'''
the Cat initializer should accept 3 arguments: name, age, and status

the introduce method for cat should return the parent's value with an added Meow Meow!
'''    
class Cat(Animal):
